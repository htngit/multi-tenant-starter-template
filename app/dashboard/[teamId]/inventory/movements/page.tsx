...
export const metadata: Metadata = {
  title: "Stock Movements | XalesIn ERP",
  description: "Track and manage inventory stock movements and transfers.",
};
    ...
    <div className="flex-1 space-y-4 p-8 pt-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Track all inventory movements including receipts, dispatches, transfers, and adjustments.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="flex items-center justify-center h-64 text-muted-foreground">
            <div className="text-center">
              ...
              <p className="text-sm">Stock movements will appear here as they are recorded</p>
            </div>
          </div>
        </CardContent>
      </Card>
