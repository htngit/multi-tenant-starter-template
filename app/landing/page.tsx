  ...
  return (
    <>
      <Hero
        ...
        title="XalesIn ERP - Solusi Bisnis Terpadu"
        subtitle="Sistem ERP modern untuk mengelola bisnis Anda dengan efisien. Dibangun dengan Next.js + Shadcn UI + Stack Auth."
      ...
      <FeatureGrid
        ...
        subtitle="Buka kemampuan powerful untuk proyek Anda."
        items={[
          {
            icon: (
            ...
            title: "Next.js 15",
            description:
              "Memanfaatkan fitur terbaru: App Router, Layouts, Suspense.",
          },
          {
            icon: (
              <svg
            ...
            title: "Shadcn UI",
            description:
              "Komponen UI modern dan dapat dikustomisasi berdasarkan Tailwind CSS.",
          },
          {
            icon: (
              <svg
            ...
            title: "Stack Auth",
            description:
              "Autentikasi Komprehensif: OAuth, Manajemen User, dan lainnya.",
          },
          {
            icon: <Users className="h-12 w-12" />,
            title: "Multi-tenancy & RBAC",
            description: "Tim dan Permissions terintegrasi.",
          },
          {
            icon: <GitHubLogoIcon className="h-12 w-12" />,
            title: "100% Open-source",
            description: "Kode sumber terbuka dan dapat di-host sendiri.",
          },
          {
            icon: <ComponentIcon className="h-12 w-12" />,
            title: "Desain Modular",
            description: "Mudah diperluas dan dikustomisasi. Tanpa kode spaghetti.",
          },
        ]}
      />
      ...
      <PricingGrid
        title="Paket Harga"
        subtitle="Paket fleksibel untuk setiap tim."
        items={[
          {
            title: "Basic",
            price: "Gratis",
          ...
          },
          {
            title: "Pro",
            price: "Rp 0",
            description: "Ideal untuk tim yang berkembang dan bisnis.",
            features: [
              "Kode sumber lengkap",
              "100% Open-source",
              "Dukungan komunitas",
